...
class SettingsView extends riverpod.ConsumerStatefulWidget {
  ...
  @override
  riverpod.ConsumerState<SettingsView> createState() =>
      _SettingsViewState();
}

class _SettingsViewState
    extends riverpod.ConsumerState<SettingsView> {
...
class SettingsLogoutButton
    extends riverpod.ConsumerWidget {
  const SettingsLogoutButton({
    super.key,
  });
